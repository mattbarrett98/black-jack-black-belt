...
![formula](https://render.githubusercontent.com/render/math?math=\pi(s)=\Large\argmax_{a%20\in%20A}Q(s,a)) , where π(s) is our estimate of the optimal policy, A is the action space and Q(s,a) is the mean reward attained taking action a in state s.
